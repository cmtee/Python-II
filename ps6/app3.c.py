...
app_ui = ui.page_fluid(
    ...
    # Toggle switch for selecting single hour or range of hours
    ui.input_checkbox("toggle_hour_range", 
    ...
    # Conditional panel for range of hours slider
...
def server(input, output, session):
    ...
    def map_plot():
        ...
        toggle_hour_range = input.toggle_hour_range()
        ...
        if toggle_hour_range:  # If the range of hours is selected
            ...
            title = f"Top Locations for Alerts between {selected_hour_range[0]}:00 and {selected_hour_range[1]}:00"
        else:  # If single hour is selected
            selected_hour = input.selected_hour()
            hour_filtered = top_alerts_map_byhour[top_alerts_map_byhour['hour'].dt.hour == selected_hour]
            title = f"Top Locations for Alerts at {selected_hour}:00"
